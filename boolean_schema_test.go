...
func TestBooleanSchemaValidation(t *testing.T) {
	t.Run("oneOf with true schema always passes", func(t *testing.T) {
		...
		_, err = v.Validate(context.Background(), "hello"); require.NoError(t, err)
		_, err = v.Validate(context.Background(), 42); require.NoError(t, err)
		_, err = v.Validate(context.Background(), true); require.NoError(t, err)
	...
	t.Run("oneOf with false schema always fails", func(t *testing.T) {
		...
		_, err = v.Validate(context.Background(), "hello"); require.Error(t, err)
		_, err = v.Validate(context.Background(), 42); require.Error(t, err)
		_, err = v.Validate(context.Background(), true); require.Error(t, err)
		_, err = v.Validate(context.Background(), nil); require.Error(t, err)
	})
